...
int X = 5; //assuming 10X10 matrix
int Y = 5; //assuming 10X10 matrix
std::vector<std::vector<int>> Cost(X, vector<int>(Y, 0));
std::vector<std::vector<int>> MinCost(X, vector<int>(Y, 0));
int test_minCostPath()
{
